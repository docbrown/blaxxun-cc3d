...
BOOL CblaxxunCC3D::loadURLfromFile2(LPCTSTR url, LPCTSTR mimeType, long lastModified, long size, LPCTSTR fileName)
{
	BOOL result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_I4 VTS_I4 VTS_BSTR;
	InvokeHelper(0x36, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
		url, mimeType, lastModified, size, fileName);
	return result;
}

void CblaxxunCC3D::onUrlNotify2(LPCTSTR url, LPCTSTR mimeType, long lastModified, long size, LPCTSTR fileName, long reason)
{
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_I4 VTS_I4 VTS_BSTR VTS_I4;
	InvokeHelper(0x37, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 url, mimeType, lastModified, size, fileName, reason);
}

void CblaxxunCC3D::print(LPCTSTR message)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CblaxxunCC3D::setViewpointByValue(float positionX, float positionY, float positionZ, float orientationX, float orientationY, float orientationZ, float orientationAngle, long mode)
{
	static BYTE parms[] =
		VTS_R4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 VTS_I4;
	InvokeHelper(0x39, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 positionX, positionY, positionZ, orientationX, orientationY, orientationZ, orientationAngle, mode);
}

void CblaxxunCC3D::getViewpointByValue(float* positionX, float* positionY, float* positionZ, float* orientationX, float* orientationY, float* orientationZ, float* orientationAngle, long mode)
{
	static BYTE parms[] =
		VTS_PR4 VTS_PR4 VTS_PR4 VTS_PR4 VTS_PR4 VTS_PR4 VTS_PR4 VTS_I4;
	InvokeHelper(0x3a, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 positionX, positionY, positionZ, orientationX, orientationY, orientationZ, orientationAngle, mode);
}

BOOL CblaxxunCC3D::getNodeBoundingBox(LPUNKNOWN node, long mode, float* xmin, float* ymin, float* zmin, float* xmax, float* ymax, float* zmax)
{
	BOOL result;
	static BYTE parms[] =
		VTS_UNKNOWN VTS_I4 VTS_PR4 VTS_PR4 VTS_PR4 VTS_PR4 VTS_PR4 VTS_PR4;
	InvokeHelper(0x3b, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
		node, mode, xmin, ymin, zmin, xmax, ymax, zmax);
	return result;
}

void CblaxxunCC3D::setUrl2(LPCTSTR url, long lastModified, long mode)
{
	static BYTE parms[] =
		VTS_BSTR VTS_I4 VTS_I4;
	InvokeHelper(0x3c, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 url, lastModified, mode);
}

long CblaxxunCC3D::getInterfaceVersion()
{
	long result;
...
void CblaxxunCC3D::setThirdPersonView(BOOL mode)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CblaxxunCC3D::getThirdPersonView()
{
	BOOL result;
...
LPUNKNOWN CblaxxunCC3D::computeRayHit(LPUNKNOWN startNode, float startx, float starty, float startz, float endx, float endy, float endz, long mode)
{
	LPUNKNOWN result;
	static BYTE parms[] =
		VTS_UNKNOWN VTS_R4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 VTS_R4 VTS_I4;
	InvokeHelper(0x40, DISPATCH_METHOD, VT_UNKNOWN, (void*)&result, parms,
		startNode, startx, starty, startz, endx, endy, endz, mode);
	return result;
}

void CblaxxunCC3D::setMyAvatarNode(LPUNKNOWN node)
{
	static BYTE parms[] =
		VTS_UNKNOWN;
...
LPUNKNOWN CblaxxunCC3D::getMyAvatarNode()
{
	LPUNKNOWN result;
...
void CblaxxunCC3D::setMyAvatarURL(LPCTSTR url)
{
	static BYTE parms[] =
		VTS_BSTR;
...
CString CblaxxunCC3D::getMyAvatarURL()
{
	CString result;
...
BOOL CblaxxunCC3D::setViewpointFollow(LPUNKNOWN node, float refX, float refY, float refZ, long mode)
{
	BOOL result;
	static BYTE parms[] =
		VTS_UNKNOWN VTS_R4 VTS_R4 VTS_R4 VTS_I4;
	InvokeHelper(0x45, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
		node, refX, refY, refZ, mode);
	return result;
}

BOOL CblaxxunCC3D::setNodeEventIn(LPCTSTR nodeName, LPCTSTR eventInName, LPCTSTR value)
{
	BOOL result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_BSTR;
	InvokeHelper(0x46, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
		nodeName, eventInName, value);
	return result;
}

CString CblaxxunCC3D::getNodeEventOut(LPCTSTR nodeName, LPCTSTR eventOutName)
{
	CString result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR;
...
LPUNKNOWN CblaxxunCC3D::getObject(long objectId)
{
	LPUNKNOWN result;
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x48, DISPATCH_METHOD, VT_UNKNOWN, (void*)&result, parms,
		objectId);
	return result;
}

void CblaxxunCC3D::setNavigationPanel(BOOL mode)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CblaxxunCC3D::getNavigationPanel()
{
	BOOL result;
