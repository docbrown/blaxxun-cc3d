...
protected:
	...
	afx_msg void OnSelchangeComboDxLevel();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
// Dialog Data
	...
	BOOL	m_useCache;
	BOOL	m_useMediaCache; // Laurent - Jan. 2000
	CString	m_cacheDirectory;
	CString	m_roCacheDirectorys;
	CString	m_mediaCacheDirectory; // Laurent - Jan. 2000
	int		m_verifyDays;
	BOOL	m_cacheRead;
	//}}AFX_DATA
...
class DAskHardwareProblem : public CDialog
{
// Construction
public:
	DAskHardwareProblem(CGLViewCtrlCtrl *ctrl=NULL, CWnd* pParent=NULL);   // standard constructor

	BOOL OnInitDialog(); 
	CGLViewCtrlCtrl *m_ctrl;

// Dialog Data
	//{{AFX_DATA(DAskHardwareProblem)
	enum { IDD = IDD_ASK_HW_PROBLEM };
...
// Overrides
	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(DAskHardwareProblem)
	protected:
	virtual void DoDataExchange(CDataExchange* pDX);    // DDX/DDV support
	//}}AFX_VIRTUAL
...
protected:
	...
	// Generated message map functions
	//{{AFX_MSG(DAskHardwareProblem)
	afx_msg void OnNormalMode();
...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// DPropPerformance dialog

class DPropPerformance : public CPropertyPage
{
	DECLARE_DYNCREATE(DPropPerformance)

// Construction
public:
	DPropPerformance(CGLViewCtrlCtrl *ctrl=NULL);
	~DPropPerformance();

	BOOL OnInitDialog(); 

	int m_textureSizeIndex;
	CGLViewCtrlCtrl *m_ctrl;


// Dialog Data
	//{{AFX_DATA(DPropPerformance)
	enum { IDD = IDD_PROP_PERFORMANCE };
	CComboBox	m_textureSizeC;
	BOOL	m_useMovies;
	BOOL	m_useSounds;
	BOOL	m_useTextures;
	float	m_visbilityFactor;
	CString	m_info;
	//}}AFX_DATA
...
protected:
	// Generated message map functions
	//{{AFX_MSG(DPropPerformance)
	afx_msg void OnSelchangeTextureSize();
	afx_msg void OnDeltaposAutoLodSpin(NMHDR* pNMHDR, LRESULT* pResult);
	afx_msg void OnDeltaposVisibilityFactorSpin(NMHDR* pNMHDR, LRESULT* pResult);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
