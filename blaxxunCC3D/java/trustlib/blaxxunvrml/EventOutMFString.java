...
// Dual interface EventOutMFString
/** @com.interface(iid=BAC50429-75D9-11D0-9315-0020AFE05CC8, thread=AUTO, type=DUAL) */
public interface EventOutMFString extends blaxxunvrml.EventOutMField
{
  ...
  /** @com.method(vtoffset=9, dispid=1610874880, type=METHOD, name="getValue")
      @com.parameters([in,type=I4] cnt, [in,out,size=1,elementType=STRING,type=ARRAY] value) */
  public void getValue(int cnt, String[] value);
  ...
  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0xbac50429, (short)0x75d9, (short)0x11d0, (byte)0x93, (byte)0x15, (byte)0x0, (byte)0x20, (byte)0xaf, (byte)0xe0, (byte)0x5c, (byte)0xc8);
}
