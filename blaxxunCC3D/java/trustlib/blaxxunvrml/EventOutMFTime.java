...
// Dual interface EventOutMFTime
/** @com.interface(iid=C5EEE9A0-6771-11D2-ABB2-00A0C9C7B4A1, thread=AUTO, type=DUAL) */
public interface EventOutMFTime extends blaxxunvrml.EventOutMField
{
  ...
  /** @com.method(vtoffset=9, dispid=1610874880, type=METHOD, name="getValue")
      @com.parameters([in,type=I4] cnt, [in,out,size=1,elementType=R8,type=ARRAY] value) */
  public void getValue(int cnt, double[] value);

  /** @com.method(vtoffset=10, dispid=1610874881, type=METHOD, name="get1Value")
      @com.parameters([in,type=I4] index, [type=R8] return) */
  public double get1Value(int index);


  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0xc5eee9a0, (short)0x6771, (short)0x11d2, (byte)0xab, (byte)0xb2, (byte)0x0, (byte)0xa0, (byte)0xc9, (byte)0xc7, (byte)0xb4, (byte)0xa1);
}
