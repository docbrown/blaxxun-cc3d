/* ----   file information  -------------------------------------------------
   ...
   $Log: EventInMFVec2f.java,v $
   Revision 1.3  1998/03/17 14:05:19  holger
   empty message

   Revision 1.2  1997/12/10 10:34:51  kristof
   *** empty log message ***

   Revision 1.1  1997/12/02 12:10:25  kristof
   Initial revision
...
{
    // constructor
    protected EventInMFVec2f (int type, int cb, int ce)
    {
        super (type, cb, ce);
    }
