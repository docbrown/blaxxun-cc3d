...
// pPal is optional
BOOL CDIB::Create(int iWidth, int iHeight,int ibitcount, CPalette* pPal)
{
    HPALETTE hPal = NULL;
    if (pPal) hPal = (HPALETTE) pPal->m_hObject;
    return Create(iWidth, iHeight,ibitcount, hPal);
}

BOOL CDIB::Create(int iWidth, int iHeight,int ibitcount, HPALETTE hPal)
{
