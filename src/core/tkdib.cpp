...
*
* (Brief description)
* new version 18.08.95 from MSDN^0/95 WIN95 OGL 
*
...
TK_RGBImageRec *tkDIBImageLoad(const char *fileName)
{
...
*   message is put into the error stream and () is called,
*   terminating the app.
*
* History:
*  - 22-Feb-1994 -by- Gilman Wong [gilmanw]
