...
GV_NODE_SOURCE_IMP(GvTextureCoordinateBinding,GvNode);


GvTextureCoordinateBinding::GvTextureCoordinateBinding()
{
    GV_NODE_CONSTRUCTOR(GvTextureCoordinateBinding);
    isBuiltIn = TRUE;
