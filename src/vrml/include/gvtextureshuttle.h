...
==============================================================================*/
#ifndef  _GvTextureShuttle_
#define  _GvTextureShuttle_
...
class GvTextureShuttle : public GvTranslation {

    GV_NODE_HEADER(GvTextureShuttle);
  ...
  public:
	...
	// multiply matrix with top texture matrix in current state
